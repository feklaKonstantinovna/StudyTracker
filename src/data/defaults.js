...
export const BUILTIN_TEMPLATES = [
  ...
  },
  {
    ...
    name: 'Работа + учёба',
    blocks: [
      {time:'08:00',dur:30,icon:'☀️',cls:'ic-anki',title:'Утро',sub:'Короткий старт',isBreak:false,pomo:'',tasks:[]},
      {time:'19:30',dur:45,icon:'📚',cls:'ic-qa',title:'Учёба после работы',sub:'Один блок, не марафон',isBreak:false,pomo:'',tasks:[]},
      {time:'20:15',dur:15,icon:'😴',cls:'ic-break',title:'Стоп',sub:'Закрыть учёбу',isBreak:true,pomo:'',tasks:[]},
    ],
  },
  {
    id: 'tpl-soft',
    builtin: true,
    name: 'Мягкий вход после срыва',
    blocks: [
